...
<div class="container">
    <div class="page_title_field">
        <h2 class="page_subject type3">응찰</h2>
    </div>
    <div class="content_wrap page_online-auction-com page_<?=PAGE_NAME?>">
        ...
        <div class="notice">
            ...
            <div class="content">
                <ul>
                    <li>1. 응찰 후에는 <span class="highlight">취소가 불가</span>합니다. 신중히 결정해 주시기 바랍니다.</li>
                    <li>2. 본 경매는 <span class="highlight">실물 확인 후 응찰을 전제</span>로 하며, 작품 및 액자 상태에 대한 이유로 응찰철회가 불가합니다.</li>
                    <li>3. 예약응찰은 오후 3시까지만 가능합니다.</li>
