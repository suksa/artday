    ...
    <div class="content_wrap page_<?=PAGE_NAME?>">
        <div class="mypage_layout clearfix">
            ...
            <div class="box">
                ...
                <p>낙찰대금은 경매후 7일 이내에 입금이 원칙입니다. 입금이 늦어질 경우 당사 회계팀에 연락 부탁드립니다. 02-3210-2255</p>
                <p><b>낙찰 철회는 불가</b>하나 피치못한 사유일 경우 위탁자의 동의하에 가능하며 <b>낙찰금액의 30%에 해당하는 위약금</b>을 받고 있습니다.</p>
            ...
            <table class="tbl_type1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="price2">1,008,000</td>
                        <td class="fees">9,999,999</td>
                        <td class="deposit"><div class="d_info_box">낙찰대입금<br>2020-04-20</div></td>
                        <td class="state confirmation">
                            <span class="btn_small grey">확인</span> <!-- grey red green -->
                        </td>
                    </tr>
                </tbody>
            </table>
